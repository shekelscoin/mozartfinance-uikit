...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) { return (React__default['default'].createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React__default['default'].createElement(Icon$M, { width: size, height: size }))); });
...
var StyledImage$2 = styled__default['default'].img(templateObject_1$u || (templateObject_1$u = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  max-width: 100%;\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  max-width: 100%;\n"])));
...
var Image = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$1, __assign({ ref: imgRef }, otherProps), isLoaded ? React__default['default'].createElement(StyledImage$2, { src: src, alt: alt }) : React__default['default'].createElement(Placeholder, null)));
};
...
var NotificationDotRoot = styled__default['default'].span(templateObject_1$q || (templateObject_1$q = __makeTemplateObject(["\n  display: inline-flex;\n  position: relative;\n"], ["\n  display: inline-flex;\n  position: relative;\n"])));
...
var SliderContainer = styled__default['default'](Box)(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n  position: relative;\n  height: 48px;\n"], ["\n  position: relative;\n  height: 48px;\n"])));
var SliderLabel = styled__default['default'].label(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  position: absolute;\n  bottom: 0;\n  margin-left: 16px; // offset the bunny butt width\n  left: calc(", "%);\n"], ["\n  position: absolute;\n  bottom: 0;\n  margin-left: 16px; // offset the bunny butt width\n  left: calc(", "%);\n"])), function (_a) {
    var progress = _a.progress;
    return progress;
});
styled__default['default'].img(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  position: absolute;\n"], ["\n  position: absolute;\n"])));
var BunnySlider = styled__default['default'].div(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: absolute;\n  left: 14px;\n  width: 100%;\n"], ["\n  position: absolute;\n  left: 14px;\n  width: 100%;\n"])));
...
var Slider = function (_a) {
    ...
    return (React__default['default'].createElement(SliderContainer, __assign({}, props),
        React__default['default'].createElement(Icon$q, { style: { position: "absolute" } }),
...
var StyledImage$1 = styled__default['default'].img(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n    height:100%;\n"], ["\n    height:100%;\n"])));
var StyledImage2 = styled__default['default'].img(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n    height:32px;\n    width:32px\n"], ["\n    height:32px;\n    width:32px\n"])));
var Logo = function (_a) {
    var isPushed = _a.isPushed, togglePush = _a.togglePush; _a.isDark; var href = _a.href;
    var isAbsoluteUrl = href.startsWith("http");
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(StyledImage$1, { className: "desktop-icon", src: "/images/logoWithText.png", width: 156 }),
        React__default['default'].createElement(StyledImage2, { className: "mobile-icon", src: "/images/piano.png" })));
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://bscscan.com/token/0xd46936677b2c1bb696f2b67c55239331e2b7cd42", target: "_blank" },
        React__default['default'].createElement(StyledImage, { src: "/images/piano.png" }),
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React__default['default'].createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React__default['default'].createElement(Icon$I, { width: "32px", height: "32px" }));
    if (isExternal) {
